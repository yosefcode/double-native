double game: Privacy policy
Welcome to the double game app for Android!

This is an open source Android app developed by yosef. The source code is available on GitHub under the MIT license; the app is also available on Google Play.
